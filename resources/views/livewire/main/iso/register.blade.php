<div>
    ...
    <div class="flex justify-between">
        <p class="ml-2 text-lg text-black font-semibold">Register a new ISO</p>

        <div class=""  align="right">
            <div wire:loading.remove wire:target="registerISO">
                <button wire:click='registerISO' class="mr-2 inline-block px-6 py-2 border-2 border-gray-800 text-gray-800 font-medium text-xs
        leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out" >
            ...
            <div wire:loading wire:target="registerISO">
    ...
    <div class="w-full max-w-lg rounded-lg bg-white mx-auto">
