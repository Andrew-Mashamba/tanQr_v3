<div>
    <style>
        ...
        .yellow-border-div {
            border-left: 4px solid #AF0A35; /* #ffff00 is the hex code for yellow */
        }
    </style>
    <div class="grid grid-cols-8 grid-rows-1" >
        ...
        <div class="row-span-1 col-span-1 bg-slate-50 border-r flex flex-col">
            ...
            <div class="flex h-16 border-b w-full shadow-sm pt-6 pb-6" style="background-color: #AF0A35">

                <div id="vcenter" class="my-auto">
                    <p class="text-sm font-bold ml-3 text-white">DATALINK - TANQR</p>
            ...
            <div class="h-full">
                ...
                <div wire:click="menuItemClicked(2)"
                     class="@if( $tab_id == 2 ) yellow-border-div border-t border-b  bg-white @else border-l-transparent @endif
                        px-5 py-4   flex items-center cursor-pointer border-l-4 hover:bg-slate-100">
                    <div class="">
                        <p  class="text-md font-semibold text-slate-600 m-0 p-0">Parteners
                        </p>
                        <p class="text-xs text-slate-400 -mt-0.5 font-semibold" >Parteners Management</p>
                    </div>
                </div>
        ...
        <div class="row-span-1 col-span-7 flex flex-col bg-white" >
            ...
            <div class="flex h-16 border-b w-full shadow-sm " style="background-color: #AF0A35">
                ...
                <nav class="w-full px-4 py-4 flex justify-between">
                    ...
                    <div>
                        ...
                        <div wire:loading wire:target="menuItemClicked" >
                            <div class="flex">
                                <svg xmlns="http://www.w3.org/2000/svg" class="animate-spin  h-6 w-6 stroke-white" fill="white" viewBox="0 0 24 24" stroke="white" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />

                                </svg>

                                <p class="ml-4 text-lg text-white font-bold  font-semibold">Please wait...</p>
                            </div>
                        ...
                        <div  wire:loading.remove wire:target="menuItemClicked">
                            ...
                            <div class="flex">
                                <a class="text-3xl font-bold leading-none" href="#">
                                    ...
                                    @if($this->tab_id == 2 )
                                        <svg class="w-6 h-6" fill="white" stroke="white" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    ...
                                    @endif
                                    @if($this->tab_id == 4 )
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-6 h-6" stroke="white" >
                    ...
                    <ul class="flex items-center space-x-6">
                        @if($this->tab_id == 1 )
                            <li><a class="text-sm text-white hover:text-gray-500" href="#">Yearly</a></li>
                            <li class="text-gray-300">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="white" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                                </svg>

                            </li>
                            <li><a class="text-sm text-white hover:text-gray-500" href="#">Monthly</a></li>
                            <li class="text-gray-300">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="white" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                                </svg>
                            ...
                            <li><a class="text-sm text-white hover:text-gray-500" href="#">Weekly</a></li>
