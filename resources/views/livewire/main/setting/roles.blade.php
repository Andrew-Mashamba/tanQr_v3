    ...
    <div class="border-b border-gray-200 dark:border-gray-700">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
            <li class="mr-2" wire:click="setView(1)">
                <a href="#" class="inline-flex p-4 @if($selected == 1) text-yellow-600 border-b-2 border-yellow-600
                    active dark:text-yellow-500 dark:border-yellow-500 @else border-transparent hover:text-gray-600
                    hover:border-gray-300 dark:hover:text-gray-300 @endif rounded-t-lg
                      group" @if($selected == 1) aria-current="page" @endif>
                    <svg aria-hidden="true" class="w-5 h-5 mr-2 @if($selected == 1) text-yellow-600 dark:text-yellow-500
                ...
                <li class="mr-2" wire:click="setView(2)">
                    <a href="#" class="inline-flex p-4 @if($selected == 2) text-yellow-600 border-b-2 border-yellow-600
                    active dark:text-yellow-500 dark:border-yellow-500 @else border-transparent hover:text-gray-600
                    hover:border-gray-300 dark:hover:text-gray-300 @endif rounded-t-lg
                      group" @if($selected == 2) aria-current="page" @endif >
                        <svg aria-hidden="true" class="w-5 h-5 mr-2 @if($selected == 2) text-yellow-600 dark:text-yellow-500
                        @else text-gray-400 group-hover:text-gray-500
                ...
                <li class="mr-2" wire:click="setView(3)">
                    <a href="#" class="inline-flex p-4 @if($selected == 3) text-yellow-600 border-b-2 border-yellow-600
                    active dark:text-yellow-500 dark:border-yellow-500 @else border-transparent hover:text-gray-600
                    hover:border-gray-300 dark:hover:text-gray-300 @endif rounded-t-lg
                      group" @if($selected == 3) aria-current="page" @endif >
                        <svg aria-hidden="true" class="w-5 h-5 mr-2 @if($selected == 3) text-yellow-600 dark:text-yellow-500
                        @else text-gray-400 group-hover:text-gray-500
                        dark:text-gray-500 dark:group-hover:text-gray-300 @endif "
                             fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5
    ...
    <div class="bg-gray-100 p-2 rounded-2xl mt-4">
        ...
        @if($selected == 1)
            ...
            <div class="w-full bg-white p-4 sm:p-6 overflow-hidden rounded-2xl shadow-md shadow-gray-200" >
                ...
                <livewire:main.setting.department-list/>
        ...
        @if($selected == 2)
            <div class="w-full bg-white p-4 sm:p-6 overflow-hidden rounded-2xl shadow-md shadow-gray-200" >
                ...
                <livewire:main.setting.create-role/>
                <div class="mt-4"></div>
        ...
        @if($selected == 3)
            ...
            <div class="w-full bg-white p-4 sm:p-6 overflow-hidden rounded-2xl shadow-md shadow-gray-200" >
                ...
                <livewire:main.setting.edit-department/>
                <div class="mt-4"></div>
