...
<div>
        ...
        <div class="mt-1 flex-shrink-0 w-1/2">
            <label class="inline-flex items-center">
                <input type="checkbox" value="1" wire:model="requireSpecialCharacter"
                       class="form-checkbox h-6 w-6 text-yellow-500 bg-gray-100
                       rounded border-gray-300 focus:ring-yellow-500 dark:focus:ring-yellow-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        ...
        <div class="mt-1 flex-shrink-0 w-1/2">
            ...
            @if($this->passwordExpire)
                ...
                <label class="inline-flex items-center">
                    ...
                    rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full  dark:bg-gray-700
                ...
                <div class="text-sm text-yellow-500">Invalid input value days</div>
                @enderror
    ...
    <div class="flex justify-end w-auto" >
        <div wire:loading wire:target="save" >
            <button class="text-white bg-yellow-400 hover:bg-yellow-400 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-yellow-400 dark:hover:bg-yellow-400 dark:focus:ring-yellow-400" disabled>
    ...
    <div class="flex justify-end w-auto" >
        <div wire:loading.remove wire:target="save" >
            <button wire:click="save" class="text-white bg-yellow-400 hover:bg-yellow-400 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-yellow-400 dark:hover:bg-yellow-400 dark:focus:ring-yellow-400">
                save policy
            </button>
        </div>
    </div>
